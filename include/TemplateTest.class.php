...
<head>
  ...
  <link rel="shortcut icon" type="image/x-icon" href="http://www.calaphio.com/favicon.ico" />
...
<div id="paperLayer1">
  <div id="paperLayer2">
    ...
    <div class="fade">
        ...
        <img id="header_photo_fade" src="header_photos/KS6.jpg" alt="Photo of brothers fade" />
    </div>
...
DOCHERE_print_body_header;
    ...
    <div id="paperFooter">
	<p><a href="pledging.php">About Us</a> | <a href="sitemap.php">Site Map</a> | <a href="http://www.apo.org">National Website</a> | <a href="http://www.berkeley.edu">UC Berkeley</a> | <a href="contact.php">Contact Us</a></p>
    </div>
  </div>
</div>
